...
public class movieSQL extends DAOBase implements movieDAO{
	...
	public int updatemoive(moive moive)throws SQLException
	{
		...
		ps.setInt(12, moive.getMovie_ID());
		ps.setString(1, moive.getMovie_Name());
		ps.setString(2, moive.getMovie_official_website());
		ps.setInt(3,moive.getMovie_Length());
		ps.setString(4, moive.getMoive_IMDB_Link());
		ps.setString(5, moive.getMovie_description());
		ps.setString(6, moive.getDouban_score());
		ps.setInt(7, moive.getDouban_human_number());
		ps.setString(8, moive.getOther_name());
		ps.setString(9 , moive.getUpdate_time());
		ps.setString(10 , moive.getMovie_Area());
		ps.setString(11, moive.getMovie_Language());
		i = ps.executeUpdate();
		ps.close();
		conn.close();
		return i;
